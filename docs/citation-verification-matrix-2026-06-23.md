...
| 21 | Lund–Sheffer–de Zeeuw 2016, *DCG* 56(2), 337–356, DOI 10.1007/s00454-016-9783-5, arXiv:1411.6868, SoCG DOI 10.4230/LIPIcs.SOCG.2015.537 | OK | Bisector-energy notion the Near Enemy Theorem **minimizes** | Direct✅ | REFINEMENT (revised 2026-09-18) | They bound E(P) both **above and below** — the abstract states the lower bound E(P) = Ω(M(n)n²), so a universal quadratic floor is theirs. Ours is the **exact** constant `2n(n−1)`, its attainment, sufficiency of bisector injectivity, `rotationEnergy = 0`, and the bundle. Earlier wording ("they use it for upper bounds; minimization + floor are ours") overstated the split |
