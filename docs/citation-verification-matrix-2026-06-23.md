...
| 21 | Lund–Sheffer–de Zeeuw 2016, *DCG* 56(2), 337–356, DOI 10.1007/s00454-016-9783-5, arXiv:1411.6868, SoCG DOI 10.4230/LIPIcs.SOCG.2015.537 | OK | Bisector-energy notion the Near Enemy Theorem **minimizes** | Direct✅ | PRIOR ART (revised 2026-09-18, twice) | **The SoCG version is not the same document as the arXiv version.** SoCG 2015 / LIPIcs vol. 34, footnote 1 p. 538 states `E(P) = 2n(n − 1)` for the bisector-injective case, with the trivial-quadruple enumeration that proves it — the exact constant and the sufficiency direction, both by these authors. That footnote is absent from arXiv:1411.6868v1, the copy vendored in `docs/references/`. Their universal asymptotic floor is §3.4 p. 545 ("an arbitrary point set has E(P) = Ω(n²)"), **not** Theorem 2.2, which is an existence statement about the *maximum* bisector energy ("there exists a set P …", proved by an ellipse construction). The first 2026-09-18 revision cited the abstract and reached the right conclusion by the wrong route. See `docs/near-enemy-prior-art-2026-09-18.md` |
