# Nivasch, Pach, Pinchasi, Zerbib (2013)

**Status:** ✅ Verified (metadata + content, from local copy)
...
`docs/references/nivasch-pach-pinchasi-zerbib-2013-distinct-distances-convex-polygon.pdf`.
Also the ingested corpus `fox-pach-2012-arxiv-1207-1266` (arXiv:1207.1266). Read
...
- Content claims: ✅ "Credits Dumitrescu's bound and sharpens it." Confirmed: the
  ...
  P [is in convex position]" and "we show that Dumitrescu's bound can be further
  improved." It thus credits the exact constant and provides an independent
  secondary confirmation of it.
...
this Nivasch–Pach–Pinchasi–Zerbib paper. The "fox-pach-2012" slug is a misnomer in
the corpus name; the arXiv ID and the vendored PDF both confirm the NPPZ paper.
