...
- Crossing-lemma route fork: `docs/crossing-lemma-route-fork.md`. The M-form
  ...
  algebraic arcs B2, M-form averaging lift B3). `exists_twoSidedPartition_of_arc` (`:385`) and `PolygonalArc.lean:3148`
